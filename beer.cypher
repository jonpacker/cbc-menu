...
with br,b, 
[case when b.untappd is null then null else ((b.untappd - ut_av)/ut_std) end, 
...
match (b)--(superstyle:superstyle), (b)--(metastyle:metastyle)
where rating is not null 
return b as beer, br.name as brewery, superstyle.name as superstyle, metastyle.name as metastyle, avg(rating) as avg_score, hype_score
